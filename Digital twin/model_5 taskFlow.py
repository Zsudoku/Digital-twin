...
LastEditors: ZSudoku
LastEditTime: 2022-05-06 17:11:08
...
def CreatJson():
    global TaskFlow
    if(PlanFlag == False):
        fp = codecs.open('original_output.json', 'a+', 'utf-8')
        fp.write(json.dumps(TaskFlow,ensure_ascii=False,indent=4))
        fp.write("\n,\n")
        fp.close()
    else:
        fp = codecs.open('optimize_output.json', 'a+', 'utf-8')
        fp.write(json.dumps(TaskFlow,ensure_ascii=False,indent=4))
        fp.write("\n,\n")
        fp.close()
#去重
...
def GetOriginalReport():
    ...
    for i in range(len(LisType)-1):
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'].append({})
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][i+1] = copy.deepcopy(Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][i])
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][i]['type'] = str(LisType[i])
        if(i == len(LisType)-2):
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][i+1]['type'] = str(LisType[i+1])
    #获取所有类型及数量
    # dirType = {}
    # LisNum = [0,0,0,0]
    r = 0
    ...
    for i in range(len(LisType)):
        ...
        for k in range(len(LisType)):
            if(LisType[i] ==  int(Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][k]['type'])):
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][k]['R'] = r
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][k]['S'] = s
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][k]['H'] = h
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'][k]['C'] = c
                break
    #print(Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['modules'])
    #各个堆垛机的时间
    for i in range(len(LisDdjTime)-1):
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'].append({})
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i+1] = copy.deepcopy(Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i])
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i]['stacker_id'] = i+1
        if(i == len(LisDdjTime)-2):
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i+1]['stacker_id'] = i+2
            if(LisDdjTime[i] > 28800):
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i+1]['normal_time'] = 28800
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i+1]['ex_work_time'] = LisDdjTime[i+1] - 28800
            else:
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i+1]['normal_time'] = LisDdjTime[i+1]
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i+1]['ex_work_time'] = 0
        if(LisDdjTime[i] > 28800):
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i]['normal_time'] = 28800
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i]['ex_work_time'] = LisDdjTime[i] - 28800
        else:
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i]['normal_time'] = LisDdjTime[i]
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['stacker_work_time'][i]['ex_work_time'] = 0
    #方案综述
    totalTime = 0
    for i in LisDdjTime:
        totalTime += i
    ...
    for i in range(len(LisInspect)):
        ...
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['assertType'] = typeLis
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['checkCount'] = LisInspectTaskNum[i]
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['backStorage'] = LisInspectTaskNum[i]
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['inStorage'] = LisInspectTaskNum[i]
        Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['humanTime'] = "03:49:24"
        if(LisInspectTimeX[i] > 28800):
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['workTime'] = strftime("%H:%M:%S", gmtime(28800))
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['overTime'] = strftime("%H:%M:%S", gmtime(abs(LisInspectTimeX[i] - 28800)))
        else:
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['workTime'] = strftime("%H:%M:%S", gmtime(LisInspectTimeX[i]))
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][0]['lineInfo'][i]['overTime'] = strftime("%H:%M:%S", gmtime(0))
...
def GetOptimizedReport():
    ...
    #获取所有类型
    for i in range(len(LisType)-1):
        Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'].append({})
        Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][i+1] = copy.deepcopy(Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][i])
        Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][i]['type'] = str(LisType[i])
        if(i == len(LisType)-2):
            Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][i+1]['type'] = str(LisType[i+1])
    #获取所有类型及数量
    # dirType = {}
    # LisNum = [0,0,0,0]
    r = 0
    ...
    for i in range(len(LisType)):
        ...
        #优化计划
        for k in range(len(LisType)):
            if(LisType[i] ==  int(Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][k]['type'])):
                Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][k]['R'] = r
                Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][k]['S'] = s
                Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][k]['H'] = h
                Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['modules'][k]['C'] = c
                break
    #各个堆垛机的时间
    for i in range(len(LisDdjTime)-1):
        Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'].append({})
        Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i+1] = copy.deepcopy(Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i])
        Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i]['stacker_id'] = i+1
        if(i == len(LisDdjTime)-2):
            Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i+1]['stacker_id'] = i+2
            if(LisDdjTime[i] > 28800):
                Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i+1]['normal_time'] = 28800
                Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i+1]['ex_work_time'] = round(LisDdjTime[i+1] - 28800,3)
            else:
                Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i+1]['normal_time'] = LisDdjTime[i+1]
                Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i+1]['ex_work_time'] = 0
        if(LisDdjTime[i] > 28800):
            Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i]['normal_time'] = 28800
            Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i]['ex_work_time'] = round(LisDdjTime[i] - 28800,3)
        else:
            Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i]['normal_time'] = LisDdjTime[i]
            Report['data']['reports'][0]['reportContent']['optimized_plan']['detail'][0]['stacker_work_time'][i]['ex_work_time'] = 0
