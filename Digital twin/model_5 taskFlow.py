    ...
    for i in range(len(LisDdjTime)-1):
        ...
        if(i == len(LisDdjTime)-2):
            ...
            if(LisDdjTime[i] > 28800):
                ...
                Report['data']['reports'][0]['reportContent']['original_plan']['detail'][Days]['stacker_work_time'][i+1]['ex_work_time'] = LisDdjTime[i+1] - 28800
            else:
        ...
        if(LisDdjTime[i] > 28800):
            ...
            Report['data']['reports'][0]['reportContent']['original_plan']['detail'][Days]['stacker_work_time'][i]['ex_work_time'] = LisDdjTime[i] - 28800
        else:
